export { default as SettingsDetail } from "./views/SettingsDetail";
...
export { default as Products } from "./views/Products/Products";
export { default as ProductDetail } from "./views/Products/ProductDetail";
